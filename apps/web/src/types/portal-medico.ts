/**
 * Tipos do Portal do Médico (Fase 11 — Trilha R-A consumida pela R-C).
 *
 * Espelha os DTOs em `apps/api/src/modules/portal-medico/dto/responses.ts`.
 * Mantemos a forma exata do contrato — qualquer divergência aqui é um
 * sinal de drift entre frontend e backend.
 */
import type { RepasseStatus } from './repasse';
...
export interface CirurgiasQueryParams {
  dataInicio?: string;
  dataFim?: string;
}
